...
export default function Footer() {
  ...
  return (
    <footer className="py-16 md:py-24 pl-[3px] pr-5 md:pl-[3px] md:pr-10 border-t-[3px] border-[var(--color-text)] relative" ref={ref}>
      {/* Film strip top */}
      ...
      <div className="max-w-6xl mx-auto pl-[3px]">
        {/* Logo - Retro + Pixel */}
        <motion.a
          href="#"
